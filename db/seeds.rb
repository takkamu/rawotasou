...
Ramen.create!(
  [
    ...
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/ramen14.jpg"), filename:"ramen14.jpg"), restaurant_name: 'そば学園', men_genre: 'shirunashi', soup_genre: 'shoyu', impression: '久々まぜそばデー。初めて来た。有名店らしいが、自分には合わなかった。', customer_id: Customer.find(1).id },
    ...
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/ramen14.jpg"), filename:"ramen14.jpg"), restaurant_name: 'そば学園', men_genre: 'shirunashi', soup_genre: 'shoyu', impression: 'いろんなアレンジが楽しめるまぜそば屋さん', customer_id: Customer.find(7).id },
    ...
    {image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/ramen14.jpg"), filename:"ramen14.jpg"), restaurant_name: 'そば学園', men_genre: 'shirunashi', soup_genre: 'shoyu', impression: '小腹が空いた時にパッと食べれるまぜそば。独特の味がするが個人的に大好き。', customer_id: Customer.find(3).id },
